...
object NetworkHelper {
    ...
    fun displayNetworkInfo(activity: MainActivity, cellTechText: TextView, cellLocationText: TextView, signalQualityText: TextView) {
        ...
        saveNetworkInfoToDatabase(activity, _signalStrength, _rsrq, _rsrp, _rscp, _ecNo, _plmnId, _rac, _tac, _lac, _cellId)
    }

    private fun saveNetworkInfoToDatabase(
        ...
        val networkInfo = NetworkInfo(
            ...
            rscp = rscp,
            ecNo = ecNo,
            signalQuality = calculateSignalQuality(signalStrength, rsrq, rsrp, rscp, ecNo),
            situation = "Normal" 
        )
        dbHelper.insertInfo(networkInfo)
    }
